	...
	<div class="container-xxl position-relative d-flex p-0">
		...
		<div class="sidebar pe-4 pb-3">
			<nav class="navbar bg-light navbar-light">
				...
				<div class="navbar-nav w-100">
					...
					<a href="<?= base_url('index.php/admin/dataUser') ?>" class="nav-item nav-link active"><i class="fa fa-table me-2"></i>Tables User</a>
		...
		<div class="content">
			...
			<div class="container mt-3">
				<h1 class="text-center">Table Data User</h1>
