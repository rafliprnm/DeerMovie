...
<body>
	<div class="container-xxl position-relative d-flex p-0">
		...
		<div class="content">
			...
			<div class="container">
				<h5 class="text-center">Form Add New Movie</h5>
				<div class="card p-2">
					<?php echo form_open_multipart('index.php/admin/tambahData'); ?>
					...
					<div class="card-body">
						...
						<div class="mb-3">
							...
							<input type="float" step="any" class="form-control" id="rating" name="rating" placeholder="Enter Rating">
						</div>
						<div class="mb-3">
						...
						<div class="mb-3">
							...
							<input type="number" step="any" class="form-control" id="score" name="score" placeholder="Enter Score">
						</div>
						<div class="mb-3">
							<label for="director" class="form-label">Director</label>
							<input type="text" step="any" class="form-control" id="director" name="director" placeholder="Enter Director">
						</div>
						<div class="mb-3">
							<label for="star1" class="form-label">Star1</label>
							<input type="text" step="any" class="form-control" id="star1" name="star1" placeholder="Enter Star1">
						</div>
						<div class="mb-3">
							<label for="star2" class="form-label">Star2</label>
							<input type="text" step="any" class="form-control" id="star2" name="star2" placeholder="Enter Star2">
						</div>
						<div class="mb-3">
							<label for="star3" class="form-label">Star3</label>
							<input type="text" step="any" class="form-control" id="star3" name="star3" placeholder="Enter Star3">
						</div>
						<div class="mb-3">
							<label for="star4" class="form-label">Star4</label>
							<input type="text" step="any" class="form-control" id="star4" name="star4" placeholder="Enter Star4">
						</div>
						<div class="mb-3">
							<label for="vote" class="form-label">Vote</label>
							<input type="number" step="any" class="form-control" id="vote" name="vote" placeholder="Enter Vote">
						</div>
						<div class="mb-3">
							<label for="poster" class="form-label">Upload Poster</label>
							<input type="file" step="any" class="form-control" id="poster" name="poster">
						</div>
