...
<body>
	...
	<div class="row g-4 justify-content-between container-fluid m-0 mt-2">
		<?php
		foreach ($new as $movie) :
		?>
			<div class="col-2 card bg-secondary p-1 mx-2 ">
				<a href="<?= site_url() ?>index.php/main/movie/<?= $movie->id_movie ?>">
